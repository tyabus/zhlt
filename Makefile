CXXFLAGS = -DHAVE_CONFIG_H -DSTDC_HEADERS -DSYSTEM_POSIX -DHAVE_ASM_ATOMIC_H -DHAVE_ATOMIC -DHAVE_FCNTL_H -DHAVE_PTHREAD_H -DHAVE_STDDEF_H -DHAVE_SYS_ATOMIC_H -DHAVE_SYS_RESOURCE_H -DHAVE_SYS_STAT_H -DHAVE_SYS_TIME_H -DHAVE_UNISTD_H
INCLUDES = -Icommon
LDFLAGS = -pthread
BINDIR = bin
...
BUILDTYPE = release
CXXFLAGS += -O1 -funsafe-loop-optimizations
endif
