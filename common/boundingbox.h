...
public:
    ...
    {
        BoundingBox tmpBox;
        tmpBox.m_Mins[0] = std::max(m_Mins[0], other.m_Mins[0]);
        tmpBox.m_Mins[1] = std::max(m_Mins[1], other.m_Mins[1]);
        tmpBox.m_Mins[2] = std::max(m_Mins[2], other.m_Mins[2]);
        tmpBox.m_Maxs[0] = std::min(m_Maxs[0], other.m_Maxs[0]);
        tmpBox.m_Maxs[1] = std::min(m_Maxs[1], other.m_Maxs[1]);
        tmpBox.m_Maxs[2] = std::min(m_Maxs[2], other.m_Maxs[2]);
    ...
    {
        m_Mins[0] = std::min(m_Mins[0], point[0]);
        m_Maxs[0] = std::max(m_Maxs[0], point[0]);
        m_Mins[1] = std::min(m_Mins[1], point[1]);
        m_Maxs[1] = std::max(m_Maxs[1], point[1]);
        m_Mins[2] = std::min(m_Mins[2], point[2]);
        m_Maxs[2] = std::max(m_Maxs[2], point[2]);
    }
